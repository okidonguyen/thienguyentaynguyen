    ...
    return (
        <div className='justify-content-center text-justify line-height-4'>
            <>
                ...
                <TitleHeader title={'BẢNG THÔNG BÁO'} />
                {postsData ? (
                    <NotionRenderer
                        recordMap={posts}
                        components={{
...
export async function getServerSideProps({ req, res }) {
    ...
    const postsData = await notion.getPage('315a5df9705b4b60827ab49b735be913');
    return { props: { postsData } };
}

Thongbao.Layout = PageLayout;
