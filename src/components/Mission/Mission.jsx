            ...
            <div className='surface-section px-4 py-8 md:px-6 lg:px-8 text-center'>
                ...
                <div className='grid'>
                    <div className='col-12 md:col-4 mb-4 px-4'>
                        ...
                        <div className='text-900 text-xl mb-3 font-bold'>Giúp đỡ sẻ chia</div>
                    ...
                    <div className='col-12 md:col-4 mb-4 px-4'>
                        ...
                        <div className='text-900 text-xl mb-3 font-bold'>Cải thiện cuộc sống cộng đồng</div>
                        <span className='text-700 line-height-3'>
                    ...
                    <div className='col-12 md:col-4 mb-4 px-4'>
                        ...
                        <div className='text-900 text-xl mb-3 font-bold'>Giáo dục và truyền cảm hứng</div>
                        <span className='text-700 line-height-3'>
